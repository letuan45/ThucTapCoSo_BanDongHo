...
namespace BanDongHoTTCS.DTO
{
    public class DongHo
    {
        ...
        public DongHo(string maDongHo, string tenDongHo, decimal gia, string moTa, string trangThai, string hinhAnh, string loai, string hang)
        {
        ...
        public DongHo(string maDongHo, string tenDongHo, decimal gia, int soLuongTon, string moTa, string trangThai, string hinhAnh, string loai, string hang, string nhaCungCap)
        {
            this.maDongHo = maDongHo;
            this.tenDongHo = tenDongHo;
            this.gia = gia;
